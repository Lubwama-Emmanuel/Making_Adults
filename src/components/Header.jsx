...
export default function Header({ clicked, setClicked }) {
  return (
    <header className="m-auto z-50 top-0 bg-white shadow-sm left-0 right-0 fixed flex max-w-[98%] grid-cols-[1fr_2fr] items-center justify-between py-5 px-3 sm:px-10 sm:grid md:gap-1 lg:max-w-[100%] lg:grid-cols-[1fr_4fr] lg:gap-[30%]">
      <Link to="/">
