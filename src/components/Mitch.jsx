          ...
          <div className="grid items-center lg:grid-cols-[30%_40%_30%]">
            <div className="px-10 py-8">
              <div>
                ...
                <p>Offspring of alcoholics research.</p>
                <p>Society for Psychotherapy Research.</p>
                <p>Managed care and the quality of care for adolescence.</p>
              </div>
            </div>
            ...
            <div className="">
              <div className="px-10 py-8">
                ...
                <p>Society of Consulting Psychology.</p>
                <p>Innovation: Strategy to Execution Gap Analysis.</p>
              </div>
            </div>
          </div>
          <div className="mx-auto grid w-[95%] grid-cols-[auto_auto] items-start gap-10 px-3 py-5 lg:max-w-[60%]">
            ...
            <div className="">
              <div>
                <p className="text-2xl text-blue-700">Psychologist</p>
                <p>
